...
| --- | --- | --- |
| DeepSeek | `deepseek-chat` | Tested |
| OpenAI | `gpt-4o-mini` | Not tested yet |
| Anthropic (Claude) | `claude-sonnet-4-20250514` | Not tested yet |
| ZhipuAI (GLM) | `glm-4-flash` | Not tested yet |
